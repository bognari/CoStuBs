...
#include "device/PIT.h"
  ...
  /*! Initialisiert den Timers, sodass alle "us" Mikrosekunden ein Interrupt
    * ausgeloest wird
    */
  PIT::PIT (unsigned short int us): control(CONTROL_PORT), data(DATA_PORT)
  {
    this -> interval(us);
  }
  ...
  /*! Default-Konstruktor. Das Interval wird spaeter
    ...
    */
  PIT::PIT (): control(CONTROL_PORT), data(DATA_PORT), interv(0)
  {}
  ...
  /*! Setzt das Timer-Intervall, sodass alle "us" Mikrosekunden ein Interrupt
    ...
    */
  void PIT::interval (unsigned short int us)
  {
    this -> interv = us;
