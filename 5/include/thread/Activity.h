...
public:
	...
	*/
	Activity(void*, int time = 1, bool isChild = false);
	 ...
	 *  aufgerufen werden.
	 */
	Activity(int time = 1, bool isChild = false);
...
private:
  ...
  Queue children;
  // falls eine andere Aktivitaet versucht ihn zu "killen" durch den Destruktor wird diese geblockt und nach dem ende wieder gestartet
  Activity* blocked;
};
