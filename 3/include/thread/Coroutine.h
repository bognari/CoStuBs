 ...
 * fuer alle Arten von Prozessen in Co-Stubs sind.
 *
 ...
 * Fuer Coroutinen die zum ersten mal aktiviert werden, muss
...
private:
  ...
  //! Der gerettete Stackpointer
	void* sp; 
  
  //! Wie der Stack aussehen soll
  struct TOS {
    // register
    unsigned int  edi;
    unsigned int  esi;
